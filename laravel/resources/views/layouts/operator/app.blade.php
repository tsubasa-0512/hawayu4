            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @unless (Auth::guard('operator')->check())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('operator.login') }}">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('operator.register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('operator.register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
